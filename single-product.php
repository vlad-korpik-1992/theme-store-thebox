                                    ...
                                    <div class="card__supplements__box" id="1extras-modal">
                                        ...
                                        if ($query->have_posts()) :
                                            while ($query->have_posts()) : $query->the_post();
                                                ...
                                                $variations = $product_data->get_available_variations();
                                        ?>
                                                <div class="card__supplements__box__items card__supplements__box__items--variation" <?php foreach ($variations as $variationProduct) : echo 'data-id' . $item . '="' . $variationProduct['variation_id'] . '"';
                                                                                                                                        $item++;
                                                                                                                                    endforeach; ?> data-cart="<? echo get_the_ID(); ?>">
                                                    <div class="supplements__checked">
                                                        <div class="supplements__checked__circle"></div>
                                                        <div class="supplements__checked__title"><?php the_title(); ?></div>
                                                    </div>
