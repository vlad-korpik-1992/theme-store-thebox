        ...
        <div class="card__row">
            <div class="card__box__items">
                ...
                <div class="card__box__btn">
                    ...
                    ?>
                    <a class="card__box__btn__add" href="<?php echo $buttonHref; ?>?add-to-cart=<?php echo $productId; ?>,">
                        <span>Добавить</span>
            ...
            <div class="card__box__items">
                <div class="card__box__items__inner">
                    ...
                    <p><span class="card__gramme"><?php echo $product_data->get_weight();
                                                    if (strpos($product_category, 'Напитки')) : echo ' л.';
                                                    else : echo ' г.';
                                                    endif ?></span> <?php echo get_the_content(); ?></p>
                    <?php
                    $variations = [];
                    if (strpos($product_category, 'Пицца')) :
                                    ...
                                    <div class="card__supplements__box" id="1extras-modal">
                                        ...
                                        if ($query->have_posts()) :
                                            while ($query->have_posts()) : $query->the_post();
                                                ...
                                                $variations = $product_data->get_available_variations();
                                        ?>
                                                <div class="card__supplements__box__items card__supplements__box__items--variation" <?php foreach ($variations as $variationProduct) : if($item == 1): $variationProductIdOne = $variationProduct['variation_id']; endif; echo 'data-id' . $item . '="' . $variationProduct['variation_id'] . '"';
                                                                                                                                        $item++;
                                                                                                                                    endforeach; ?> data-cart="<? echo $variationProductIdOne; ?>">
                                                    <div class="supplements__checked">
                                                        <div class="supplements__checked__circle"></div>
                                                        <div class="supplements__checked__title"><?php the_title(); ?></div>
                                                    </div>
                                                    <div class="supplements__price">
                                                        <div class="supplements__price__value">
                                                            <span class="supplements__price__span supplements__price__span--variation" <?php foreach ($variations as $variationProduct) : echo 'data-variation-price' . $itemPrice . '="' . $variationProduct['display_regular_price'] . '"';
                                                                                                                                            $itemPrice++;
                                                                                                                                        endforeach; ?>><?php echo $product_data->get_price(); ?></span>
                                                            <span>BYN</span>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        ?>
            <div class="products__box">
                ...
                while ($query->have_posts()) : $query->the_post();
                    $product_data = wc_get_product(get_the_ID());
                ?>
                    <div class="products__box__half <?php if ($item % 2 == 0) : echo 'products__box__half--borderrnone';
                                                    endif; ?>">
                        <div class="products__box__half__inner">
                            <a class="products__box__half__imglink products__box__half__imglink--drinks" href="<?php echo get_permalink($posts['ID']); ?>">
...
<section class="description">
    <div class="wrapper">
        <div class="description__box">
            <?php
                echo wpautop(get_field('card_description', get_the_ID()));
            ?>
        </div>
    </div>
</section>
